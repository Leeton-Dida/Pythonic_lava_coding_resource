            ...
            <div class="container py-4 py-lg-5" style="padding-top: 0;">
                <div class="row justify-content-center" style="margin-left: 0;margin-right: 0;">
                    ...
                    <div class="col-sm-4 col-md-3 offset-xl-1 text-center text-lg-start d-flex flex-column item">
                        <h3 class="fs-6 text-white" style="margin-left: 90px;">Ask teacher</h3>
                        <!-- <textarea style="border-width: 2px;border-radius: 8px;" placeholder="Ask anything" wrap="soft" minlength="25"></textarea> -->
                        <a href="ask teacher.php"><button class="btn btn-primary" data-bss-hover-animate="pulse" type="button" style="background: #360062;margin-right: 70px;margin-left: 50px;margin-top: 12px;padding:10px;padding-left:60px;padding-right:60px">Ask</button></a>
                    </div>
