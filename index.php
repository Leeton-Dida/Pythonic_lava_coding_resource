...
<body>
    <nav class="navbar navbar-dark navbar-expand-md fixed-top textwhite bg-dark text-white shadow-lg py-3" style="transform-style: preserve-3d;opacity: 0.83;filter: brightness(160%) saturate(200%);background: rgb(33, 37, 41);">
        <div class="container"><a class="navbar-brand d-flex align-items-center" href="index.php"><span class="bs-icon-sm bs-icon-rounded bs-icon-primary d-flex justify-content-center align-items-center me-2 bs-icon"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-bezier">
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="#" >Ask teacher</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <section style="margin-bottom: 40px;">
        <div data-bss-parallax-bg="true" style="height: 518px;background: url(&quot;assets/img/971.jpg&quot;) center / cover;margin-top: 72px;">
            <div class="container h-100">
                <div class="row h-100">
                    <div class="col-md-6 text-center text-md-start d-flex d-sm-flex d-md-flex justify-content-center align-items-center justify-content-md-start align-items-md-center justify-content-xl-center">
                        <div style="max-width: 350px;">
                            <h1 class="display-3 text-capitalize fw-bold" style="color: rgb(255,255,255);text-align: center;margin-right: -564px;font-size: 81px;">Welcome back</h1>
                        </div>
                    </div>
                </div>
            </div>
