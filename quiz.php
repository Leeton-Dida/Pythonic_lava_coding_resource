...
<body>
    <div>
        <a class="btn btn-primary btn-customized open-menu" role="button" style="
          margin-top: 2px;
          padding-top: 9px;
          padding-bottom: 10px;
          margin-right: 1687px;
        ...
        <div class="sidebar" style="background: rgb(33, 37, 41)">
            <img class="rounded" loading="lazy" src="assets/img/bs4_team_01.jpg" style="
            text-align: center;
            border-style: none;
            ...
            <nav class="navbar navbar-dark navbar-expand">
                <div class="container-fluid">
                    <ul class="navbar-nav flex-column me-auto">
                        <li class="nav-item">
                            <div class="accordion bg-dark bg-gradient border rounded border-1 border-dark shadow-lg"
                                role="tablist" id="accordion-1"
                                style="width: 214px; margin-left: -12px; margin-top: 28px">
                                <div class="accordion-item">
                                    <h2 class="accordion-header" role="tab">
                                        <button class="accordion-button border rounded border-1 border-dark shadow-lg"
                                            data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-1"
                                            aria-expanded="true" aria-controls="accordion-1 .item-1" style="
                        ...
                        ">
                                    ...
                                    <div class="accordion-collapse collapse show item-1 bg-dark" role="tabpanel"
                                        data-bs-parent="#accordion-1">
                                        <div class="accordion-body">
                                            <form>
                                                <div class="form-check">
                                                    <input id="formCheck-1" class="form-check-input" type="radio"
                                                        checked name="week_1" />
                                                    <label class="form-check-label" for="formCheck-1"
                                                        style="color: rgb(0, 0, 0)">Stuff </label><label
                                                        style="margin-left: 10px">(Visited)</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="formCheck-3" class="form-check-input" type="radio"
                                                        name="week_1" /><label class="form-check-label"
                                                        for="formCheck-3" style="color: #ffffff">Stuff</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="formCheck-2" class="form-check-input" type="radio"
                                                        name="week_1" /><label class="form-check-label"
                                                        for="formCheck-2" style="color: #ffffff">Stuff</label>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" role="tab">
                                        <button
                                            class="accordion-button collapsed border rounded border-1 border-dark shadow-lg"
                                            data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-2"
                                            aria-expanded="false" aria-controls="accordion-1 .item-2" style="
                          color: rgb(255, 255, 255);
                          background: rgb(59, 59, 59);
                        ">
                                            Week 2
                                            ...
                                            <form>
                                                <div class="form-check">
                                                    <input id="formCheck-1" class="form-check-input" type="radio"
                                                        checked name="week_1" />
                                                    <label class="form-check-label" for="formCheck-1"
                                                        style="color: rgb(0, 0, 0)">Stuff</label>
                                                </div>
                                                <div class="form-check">
                                                    <input id="formCheck-3" class="form-check-input" type="radio"
                                                        name="week_1" /><label class="form-check-label"
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" role="tab">
                                        <button
                                            ...
                                            aria-expanded="false" aria-controls="accordion-1 .item-3" style="
                          color: rgb(255, 255, 255);
                          background: rgb(59, 59, 59);
                        ">
                                            Week 3
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" role="tab">
                                        <button
                                            class="accordion-button collapsed border rounded border-1 border-dark shadow-lg"
                                            data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-4"
                                            aria-expanded="false" aria-controls="accordion-1 .item-4" style="
                          color: rgb(255, 255, 255);
                          background: rgb(59, 59, 59);
                        ">
                                            Week 4
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" role="tab">
                                        <button
                                            class="accordion-button collapsed border rounded border-1 border-dark shadow-lg"
                                            data-bs-toggle="collapse" data-bs-target="#accordion-1 .item-5"
                                            aria-expanded="false" aria-controls="accordion-1 .item-5" style="
                          color: rgb(255, 255, 255);
                          background: rgb(59, 59, 59);
                        ">
                                            Week 5
                        ...
                        <li class="nav-item">
                            <div id="Modal-button-wrapper-1" class="text-center">
                                <a class="shadow-sm bs4_modal_trigger" href="Hall%20of%20fame.html"
                                    data-modal-id="bs4_team" style="color: rgb(255, 255, 255)">hall of fame</a>
                                <hr style="margin: 25px 0px 16px; margin-top: 31px" />
                            </div>
                        </li>
                        <li class="nav-item">
                            <a class="btn btn-primary text-truncate shadow float-end tenant-continue-btn" role="button"
                                data-bss-hover-animate="pulse" style="
                    margin-right: 45px;
                    margin-top: 99px;
                    background: rgba(51, 51, 51, 0.2);
                    width: 103px;
                  " href="login.php">Log out&nbsp;<svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em"
                                    viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                                    stroke-linecap="round" stroke-linejoin="round"
                                    class="icon icon-tabler icon-tabler-logout continue-icon"
    ...
    <nav class="navbar navbar-dark navbar-expand-md textwhite bg-dark text-white shadow-lg py-3" style="
      ...
      ">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="index.php"><span
                    ...
                    </svg></span><span>Pythonic lava</span></a><button data-bs-toggle="collapse" class="navbar-toggler"
            ...
            <div class="collapse navbar-collapse" id="navcol-5">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#">Ask teacher</a>
                    </li>
                </ul>
            </div>
        </div>
...
echo '<form id="quiz_form" method="post" action="controller/quizController.php">';
...
if (mysqli_num_rows($result) > 0) {
                    ...
                    <div>
                        ...
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' id='formCheck-4'
                                name='question_".$rdoBtnNameCounter."_rdoBtn' /><label class='form-check-label' for='formCheck-4'>". $answer_array[0] ."
                                </label>
                        </div>
                        <div class='form-check' style='text-align: justify'>
                            <input class='form-check-input' type='radio' id='formCheck-4'
                                name='question_".$rdoBtnNameCounter."_rdoBtn' /><label class='form-check-label' for='formCheck-4'>" . $answer_array[1] ."</label>
                        </div>
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' id='formCheck-6'
                                name='question_".$rdoBtnNameCounter."_rdoBtn' /><label class='form-check-label' for='formCheck-6'>" . $answer_array[2] ."</label>
                        </div>
                        <div class='form-check'>
                            <input class='form-check-input' type='radio' id='formCheck-5'
                                name='question_".$rdoBtnNameCounter."_rdoBtn' /><label class='form-check-label' for='formCheck-5'>" . $answer_array[3] ."</label>
                        </div>
                    </div>
                </li>
            </ul>";
            #increase score if correct answer is selected
            if ($correct_answer == isset ($_POST['question_1_rdoBtn'])) {
                $score++;
            }
            $count++;
            $rdoBtnNameCounter ++;
    ...
    echo "<script>alert('There are no quiz today. Yay!')</script>";
            ...
            ?>
            <button class="btn btn-primary" data-bss-hover-animate="pulse" type="submit" style="
            background: #360062;
            margin-right: 65px;
            margin-left: 618px;
            margin-top: 31px;
        ...
        <footer class="text-white bg-dark" style="margin-top: 76px">
            <div class="container py-4 py-lg-5" style="padding-top: 0">
                <div class="row justify-content-center" style="margin-left: 0; margin-right: 0">
                    <div class="col-sm-4 col-md-3 text-center text-lg-start d-flex flex-column item">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a class="link-light" href="assignments.php">Assignment</a>
                            </li>
                    ...
                    <div class="col-sm-4 col-md-3 offset-xl-1 text-center text-lg-start d-flex flex-column item">
                        <h3 class="fs-6 text-white">Ask teacher</h3>
                        <textarea style="border-width: 2px; border-radius: 8px" placeholder="Ask anything" wrap="soft"
                            minlength="25"></textarea><button class="btn btn-primary" data-bss-hover-animate="pulse"
                            type="submit" style="
                  background: #360062;
                  margin-right: 70px;
                  margin-left: 70px;
                ...
                ">
                    ...
                    <div
                        class="col-lg-3 offset-xl-1 text-center text-lg-start d-flex flex-column align-items-center order-first align-items-lg-start order-lg-last item social">
                        <div class="fw-bold d-flex align-items-center mb-2">
                            <span
                                ...
                                </svg></span><span>Pythonic lava</span>
                        </div>
