            ...
            <div class="col-md-8 offset-md-2">
                <form action = "controller/registerController.php" method = "post" class="border rounded border-0 border-secondary shadow-lg custom-form" style="background: rgba(0,0,0,0.1);color: var(--bs-white);text-align: center;">
                    ...
                    <div class="row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label text-white" for="name-input-field">Name </label></div>
                        <div class="col-sm-6 input-column"><input name="txtName" class="form-control" type="text" required=""></div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label text-white" for="name-input-field">Surname</label></div>
                        <div class="col-sm-6 input-column"><input name ="txtSurname" class="form-control" type="text" required=""></div>
                    </div>
                    <div class="row form-group">
                        <div class="col-sm-4 label-column"><label class="col-form-label text-white" for="email-input-field">Email </label></div>
                    ...
                    <div class="form-check" style="margin-left: 199px;"><input class="form-check-input" type="checkbox" id="formCheck-3" required="" style="margin-left: -61px;margin-right: 140px;">
                        <label class="form-check-label" for="formCheck-3" style="margin-left: -211px;">I've read and accept the terms and conditions</label></div>
                    <button class="btn btn-light border rounded border-0 shadow-lg submit-button" data-bss-hover-animate="pulse" type="submit" style="background: var(--bs-indigo);">Register</button>
                </form>
            </div>
        </div>
    </div>
    <div id="footer" style="margin-top: 85px;">
        <footer class="text-white bg-dark" style="margin-top: 42px;">
