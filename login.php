...
<body>
  <div class="border rounded-pill border-secondary shadow-lg login-card" data-aos="fade-down" data-aos-duration="1000"
    data-aos-delay="100" data-aos-once="true" style="
    ...
    <form class="form-signin" method ="post"  action = "controller/loginController.php">
      <span class="reauth-email" style="margin: 11px"> </span><input name="txtEmail" class="form-control" type="email"
        id="inputEmail" required="" placeholder="Email address" autofocus="" /><input name="txtPassword"
        class="form-control" type="password" id="inputPassword" required="" placeholder="Password" /><button
        class="btn btn-primary btn-lg border-0 shadow-lg d-block btn-signin w-100" data-bss-hover-animate="rubberBand" name = "submit"
        style="
            font-family: Roboto, sans-serif;
            font-size: 16px;
            font-weight: normal;
  ...
  <div id="footer" style="margin-top: 300px">
    <footer class="text-white bg-dark" style="margin-top: 42px; height: 210px">
