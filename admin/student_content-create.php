...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $stmt = $pdo->prepare("INSERT INTO student_content (student_id,content_id,code,mark) VALUES (?,?,?,?)");

        if($stmt->execute([ $student_id,$content_id,$code,$mark  ])) {
                $stmt = null;
                header("location: student_content-index.php");
            } else{
