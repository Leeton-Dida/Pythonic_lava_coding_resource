            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="float-left">Content Details</h2>
                        <a href="content-create.php" class="btn btn-success float-right">Add New Record</a>
                        <a href="content-index.php" class="btn btn-info float-right mr-2">Reset View</a>
                    ...
                    $sql = "SELECT * FROM content ORDER BY $order $sort LIMIT $offset, $no_of_records_per_page";
                    ...
                    if($result = mysqli_query($link, $sql)){
                        if(mysqli_num_rows($result) > 0){
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
                                        echo "<th><a href=?search=$search&sort=&order=week_id&sort=$sort>week_id</th>";
										echo "<th><a href=?search=$search&sort=&order=task_description&sort=$sort>task_description</th>";
										echo "<th><a href=?search=$search&sort=&order=lesson_title&sort=$sort>lesson_title</th>";
										echo "<th><a href=?search=$search&sort=&order=max_blocks&sort=$sort>max_blocks</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['week_id']) . "</td>";echo "<td>" . htmlspecialchars($row['task_description']) . "</td>";echo "<td>" . htmlspecialchars($row['lesson_title']) . "</td>";echo "<td>" . htmlspecialchars($row['max_blocks']) . "</td>";
                                        echo "<td>";
