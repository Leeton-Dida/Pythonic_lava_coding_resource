        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    $orderBy = array('Name', 'Surname', 'Email', 'Password', 'score', 'quized', 'is_admin');
                    $order = 'id';
                    ...
                    if(!empty($_GET['search'])) {
                        ...
                        $sql = "SELECT * FROM users
                            WHERE CONCAT_WS (Name,Surname,Email,Password,score,quized,is_admin)
                            LIKE '%$search%'
                            ORDER BY $order $sort
                            ...
                            echo "<table class='table table-bordered table-striped'>";
                                echo "<thead>";
                                    echo "<tr>";
										...
										echo "<th><a href=?search=$search&sort=&order=Surname&sort=$sort>Surname</th>";
										...
										echo "<th><a href=?search=$search&sort=&order=score&sort=$sort>score</th>";
										echo "<th><a href=?search=$search&sort=&order=quized&sort=$sort>quized</th>";
										echo "<th><a href=?search=$search&sort=&order=is_admin&sort=$sort>is_admin</th>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                    echo "<td>" . htmlspecialchars($row['Name']) . "</td>";echo "<td>" . htmlspecialchars($row['Surname']) . "</td>";echo "<td>" . htmlspecialchars($row['Email']) . "</td>";echo "<td>" . htmlspecialchars($row['Password']) . "</td>";echo "<td>" . htmlspecialchars($row['score']) . "</td>";echo "<td>" . htmlspecialchars($row['quized']) . "</td>";echo "<td>" . htmlspecialchars($row['is_admin']) . "</td>";
                                        echo "<td>";
